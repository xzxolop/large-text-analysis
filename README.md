...
```
cd existing_repo
git remote add origin https://gitlab.com/xzxolop/large-text-analysis.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/xzxolop/large-text-analysis/-/settings/integrations)
