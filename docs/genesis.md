...
Тесты проводились для тасета редита 
Исходных текстов:  54848
Всего предложений:  140482
...
Итого на подготовку к работе: 
Сложность: O(n^3) + O(n^2) + O(n)
Время: 21.26 секунд

На поиск:
Сложность: O(n^2) + O(2*n)
Время: ~1 секунд
